...
/**
 * 插件表变更历史明细  user_plugin_change_history_detail
 * 
 * @author qixingshen
 * @date 2018-06-01
 **/
@Entity
@Table(name = "user_plugin_change_history_detail")
public class UserPluginChangeHistoryDetail {
	...
	public String toString() {
		return String.format("UserPluginChangeHistoryDetail{id = %s ,"
				+ "changeFieldComment = %s , changeFieldName = %s , changeBefore = %s , "
				+ "changeAfter = %s}", id,changeFieldComment,changeFieldName,changeBefore,changeAfter);
	}
}
