...
/**
 * 用户重置密码邮件校验码 user_password_check_code
 * 
 * @author qixingshen
 * @date 2018-07-07
 **/
@Entity
@Table(name = "user_password_check_code")
public class UserPasswordCheckCode {
	...
	public String toString() {
		return String.format(
				"UserPasswordCheckCode{id = %s , userId = %s , checkCode = %s , sendDate = %s , validateMinutes = %s , status = %s}",
