package com.qxs.plugin.generator.mybatis.lombok.service.impl;
 ...
 */
public class MybatisLombokServiceImplGenerator extends AbstractGenerator implements IGenerator {
    ...
    protected TemplateModel wrap(PluginConfig[] allPluginConfigs,PluginConfig pluginConfig, Table table, String[] removePrefixs)
        ...
        String daoClassParameterName = daoClassName;
        ...
        daoClassName = daoPluginConfig.getPrefix() + className + daoPluginConfig.getSuffix();
        daoClassParameterName = className + daoPluginConfig.getSuffix();
        
        map.put("daoClassName", daoClassName);
        map.put("daoClassParameterName",daoClassParameterName.substring(0, 1).toLowerCase() + daoClassParameterName.substring(1));
