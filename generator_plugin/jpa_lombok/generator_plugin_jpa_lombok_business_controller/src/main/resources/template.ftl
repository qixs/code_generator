...
//	@PostMapping
	@ResponseBody
	public void create(@Validated ${className} ${entityClassParameterName}) {

		${businessClassParameterName}.insert(${entityClassParameterName});
	}
...
//	@PutMapping
	@ResponseBody
	public void update(@Validated ${className} ${entityClassParameterName}) {

		${businessClassParameterName}.update(${entityClassParameterName});
	}
...
//	@DeleteMapping("/{${primaryKeyColumn.javaName}}")
	@ResponseBody
	public void deleteById(@PathVariable("${primaryKeyColumn.javaName}") ${primaryKeyColumnClassName} ${primaryKeyColumn.javaName}) {

		${businessClassParameterName}.deleteById(${primaryKeyColumn.javaName});
	}
</#if>
}